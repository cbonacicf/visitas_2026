    ...
    return html.Div([
        dbc.Row([
            ...
            dbc.Col([
                ...
                dbc.Input(type='text', id='contacto-mail', placeholder='Correo (máx. 55 caracteres)', debounce=True),
            ...
            dbc.Col([
                ...
                dbc.Input(type='text', id='orienta-mail', placeholder='Correo (máx. 55 caracteres)', debounce=True),
            ], style={'width': '40%'}),
        ]),
        linea,
    ])
    ...
    return html.Div([
        dbc.Row([
            ...
            dbc.Col([
                ...
                dbc.Input(value=mail_ctto, type='text', id='mod-contacto-mail', placeholder='Correo (máx. 55 caracteres)', debounce=True),
            ...
            dbc.Col([
                ...
                dbc.Input(value=mail_ori, type='text', id='mod-orienta-mail', placeholder='Correo (máx. 55 caracteres)', debounce=True),
